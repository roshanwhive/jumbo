...
(function ($) {
  ...
  var drawers = {
    ...
    destroy: function (handle) {
      var handleName = this.readableName(handle);
      if (
        this.states[handleName] &&
        typeof this.states[handleName] !== "undefined"
      ) {
  ...
  $("ul.sub-menu li").on("click", function (e) {
    ...
    if ($current_sm_li_parent.parent().hasClass("active")) {
      ...
      $("li ul", $current_sm_li_parent)
        .not($("ul", $current_sm_li))
        .slideUp(slideDuration, function () {
          $("li", $current_sm_li_parent)
            .not($current_sm_li)
            .removeClass("active");
        });
    } else {
  ...
  // color theme panel
  drawers.init("#colorTheme, #close-setting-panel", {
    menu: "#colorSidebar",
    side: "right",
  });
  ...
  $("#switch-dark-theme").on("change", function () {
    ...
    if ($(this).is(":checked")) {
      ...
      $("#override-css-id").attr(
        "href",
        "css/theme-" + dark_theme + ".min.css"
      );
    } else {
      ...
      if (current_theme) {
        $("#override-css-id").attr(
          "href",
          "css/theme-" + current_theme + ".min.css"
        );
      }
...
function calc_height() {
  ...
  var main_content_padding = parseInt(
    jQuery(".gx-main-content").css("padding-top")
  );

  var gxwrapper_margin = parseInt(jQuery(".gx-wrapper").css("margin-bottom"));

  var gxmodule_margin =
    parseInt(jQuery(".gx-module").css("margin-top")) +
    parseInt(jQuery(".gx-module").css("margin-bottom"));
  ...
  var module_listScroll_padding =
    parseInt(jQuery(".module-list-scroll").css("padding-top")) +
    parseInt(jQuery(".module-list-scroll").css("padding-bottom"));
  ...
  var scrollbar_height =
    ...
    (main_header_height +
      ...
      gxmodule_margin +
      main_footer_height +
      modulebox_header_height +
      modulebox_topbar_height +
      module_listScroll_padding +
      todo_main_footer);
